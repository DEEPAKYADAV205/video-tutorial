...
public class ListViewPendingAdapter extends BaseAdapter {
	...
	public ListViewPendingAdapter(Context context, List<Order> orderlist) {
	...
	public View getView(final int position, View view, ViewGroup parent) {
		...
		if (view == null) {
			...
			view = inflater.inflate(R.layout.pendinglist, null);
		...
		view.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent intent = new Intent(context, PendingItemView.class);
				// Pass all data rank
