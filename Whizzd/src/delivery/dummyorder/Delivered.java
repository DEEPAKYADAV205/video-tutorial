...
public class Delivered extends Activity implements
		ActionBar.OnNavigationListener {
	// Declare Variables
	ListView listview;
	List<ParseObject> ob;
	ProgressDialog mProgressDialog;
	ListViewDeliverAdapter adapter;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.listview_main1);
	...
	private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			mProgressDialog = new ProgressDialog(Delivered.this);
		...
		protected void onPostExecute(Void result) {
			...
			adapter = new ListViewDeliverAdapter(Delivered.this, deliverlist);
