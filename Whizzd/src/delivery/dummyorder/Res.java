...
@SuppressLint("NewApi")
public class Res extends Activity implements ActionBar.OnNavigationListener {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_add:
			// location found
			Intent i = new Intent(Res.this, ResturantSignup.class);
			startActivity(i);
		...
		case R.id.action_check_settings:
			// check for updates action
			startActivity(new Intent(Res.this, SettingsActivity.class));
			return true;
		default:
	...
	private class GetContacts extends AsyncTask<Void, ArrayList<String>, Void> {
		...
		protected void onPreExecute() {
			...
			pDialog = new ProgressDialog(Res.this);
		...
		protected Void doInBackground(Void... arg0) {
			...
			try {
				if (jsonStr != null) {
					...
					if (contactList != null) {
						Intent intentmap = new Intent(Res.this, ResMap.class);
