...
public class ListViewDeliveredAdapter extends BaseAdapter {
	...
	public ListViewDeliveredAdapter(Context context, List<Deliver> deliverlist) {
	...
	public View getView(final int position, View view, ViewGroup parent) {
		...
		if (view == null) {
			...
			view = inflater.inflate(R.layout.deliveredorderlistview, null);
		...
		view.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent intent = new Intent(context, DeliveredItemView1.class);
				// Pass all data rank
