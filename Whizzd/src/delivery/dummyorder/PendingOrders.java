...
public class PendingOrders extends Activity implements
		ActionBar.OnNavigationListener {
	// Declare Variables
	ListView listview;
	List<ParseObject> ob;
	ProgressDialog mProgressDialog;
	ListViewPendingAdapter adapter;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pendingorders);
	...
	private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			mProgressDialog = new ProgressDialog(PendingOrders.this);
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				...
				for (ParseObject order : ob) {
					...
					map.setAmount((String) order.get("tearning"));
		...
		protected void onPostExecute(Void result) {
			...
			adapter = new ListViewPendingAdapter(PendingOrders.this, orderlist);
