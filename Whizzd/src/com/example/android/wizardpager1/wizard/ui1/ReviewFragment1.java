...
import com.example.android.wizardpager1.wizard.model1.ReviewItem1;

import delivery.dummyorder.R;

public class ReviewFragment1 extends ListFragment implements ModelCallbacks1 {
    private Callbacks mCallbacks;
    private AbstractWizardModel1 mWizardModel;
    private List<ReviewItem1> mCurrentReviewItems;

    private ReviewAdapter mReviewAdapter;

    public ReviewFragment1() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_page11, container, false);
    ...
    @Override
    public void onPageDataChanged(Page1 changedPage) {
        ArrayList<ReviewItem1> reviewItems = new ArrayList<ReviewItem1>();
        for (Page1 page : mWizardModel.getCurrentPageSequence()) {
            page.getReviewItems(reviewItems);
        }
        Collections.sort(reviewItems, new Comparator<ReviewItem1>() {
            @Override
            public int compare(ReviewItem1 a, ReviewItem1 b) {
    ...
    public interface Callbacks {
        AbstractWizardModel1 onGetModel();
    ...
    private class ReviewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup container) {
            ...
            ReviewItem1 reviewItem = mCurrentReviewItems.get(position);
