...
public class StepPagerStrip1 extends View {
    ...
    public StepPagerStrip1(Context context) {
        this(context, null, 0);
    }

    public StepPagerStrip1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StepPagerStrip1(Context context, AttributeSet attrs, int defStyle) {
