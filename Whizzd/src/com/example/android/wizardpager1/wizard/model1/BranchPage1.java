 ...
 */
public class BranchPage1 extends SingleFixedChoicePage1 {
    private List<Branch> mBranches = new ArrayList<Branch>();

    public BranchPage1(ModelCallbacks1 callbacks, String title) {
    ...
    public Page1 findByKey(String key) {
        ...
        for (Branch branch : mBranches) {
            Page1 found = branch.childPageList.findByKey(key);
            if (found != null) {
                return found;
            }
        }
    ...
    @Override
    public void flattenCurrentPageSequence(ArrayList<Page1> destination) {
        super.flattenCurrentPageSequence(destination);
        for (Branch branch : mBranches) {
            if (branch.choice.equals(mData.getString(Page1.SIMPLE_DATA_KEY))) {
    ...
    public BranchPage1 addBranch(String choice, Page1... childPages) {
        PageList1 childPageList = new PageList1(childPages);
        for (Page1 page : childPageList) {
    ...
    public BranchPage1 addBranch(String choice) {
        mBranches.add(new Branch(choice, new PageList1()));
        return this;
    }
    ...
    public BranchPage1 setValue(String value) {
    ...
    private static class Branch {
        ...
        public PageList1 childPageList;

        private Branch(String choice, PageList1 childPageList) {
            this.choice = choice;
