 ...
 */
public class PageList1 extends ArrayList<Page1> implements PageTreeNode1 {
    
    public PageList1() {
        
    }
    
    public PageList1(Page1... pages) {
        for (Page1 page : pages) {
            add(page);
        }
    }
    ...
    public Page1 findByKey(String key) {
        for (Page1 childPage : this) {
            Page1 found = childPage.findByKey(key);
            if (found != null) {
                return found;
            }
        }
