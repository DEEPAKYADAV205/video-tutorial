 ...
 */
public abstract class AbstractWizardModel1 implements ModelCallbacks1 {
    protected Context mContext;

    private List<ModelCallbacks1> mListeners = new ArrayList<ModelCallbacks1>();
    private PageList1 mRootPageList;

    public AbstractWizardModel1(Context context) {
        mContext = context;
     ...
     */
    protected abstract PageList1 onNewRootPageList();
    ...
    public void registerListener(ModelCallbacks1 listener) {
        mListeners.add(listener);
    }

    public Bundle save() {
        Bundle bundle = new Bundle();
        for (Page1 page : getCurrentPageSequence()) {
     ...
     * user's choices.
     */
    public List<Page1> getCurrentPageSequence() {
        ArrayList<Page1> flattened = new ArrayList<Page1>();
        mRootPageList.flattenCurrentPageSequence(flattened);
        return flattened;
    }

    public void unregisterListener(ModelCallbacks1 listener) {
